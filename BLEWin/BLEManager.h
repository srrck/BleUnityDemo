...
extern "C" {
    ...
    BLEMANAGER_API bool WriteCharacteristicUuid(const wchar_t* deviceId, const wchar_t* serviceUuid, const wchar_t* characteristicUuid, const uint8_t* data, int length);
...
public:
    ...
    bool WriteByUuid(const wchar_t* deviceId, const wchar_t* serviceUuid, const wchar_t* characteristicUuid, const std::vector<uint8_t>& data);
